      ...
      <header className="max-w-6xl mx-auto px-6 pt-16 pb-10 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            ...
            <button className="px-6 py-3 rounded-lg bg-white text-blue-700 font-semibold border border-blue-200 hover:bg-blue-50" onClick={() => navigate("/upload")}>View analyses</button>
          </div>
