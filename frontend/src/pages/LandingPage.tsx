      ...
      <section id="features" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 tracking-tight">Intelligence at your fingertips</h2>
            <p className="text-zinc-600 dark:text-zinc-400">Everything you need to analyze, optimize, and land your next role.</p>
          </div>
